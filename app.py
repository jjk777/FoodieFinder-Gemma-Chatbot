...
def launch(input):
    ...
    out = gemma_finetuned.generate(prompt, max_length=800)
...
### Other prompts:
Series of questions to ask are as follows:
Set1:
- "What are the seven regions of Japan known for their distinct culinary traditions?"
- "What dishes would you recommend in Kansai?"
- "What dishes would you recommend in Chugoku?"
- "Which dishes are a must-try in Okinawa?"
...
- "What makes Fukuoka Ichiran a beloved ramen spot?"
- "How do Fukuoka Ichiran and Hakata Ippudo compare in terms of characteristics?"
...
Set3:
- "I want to try sukiyaki, what is a recommended sukiyaki place in Japan?"
- "Could you give me some details about Hari Ju Dotonbori Honten."
- "What is the price normally spent for dining at the restaurant Hari Ju Dotonbori Honten?"
- "What is the average rating of Hari Ju Dotonbori Honten?"
- "What is the location of Hari Ju Dotonbori Honten in Japan?"
- "What is the full address of Hari Ju Dotonbori Honten?"

Set4:
- "What restaurants are known for friendly and attentive staff, and beautiful ambiance?", "What restaurants are known for authentic food, and great service?", "What restaurants are known for great service, and romantic setting?". Then follow up questions (just like Set3) about the outputted restaurant's rating, location, and details.
